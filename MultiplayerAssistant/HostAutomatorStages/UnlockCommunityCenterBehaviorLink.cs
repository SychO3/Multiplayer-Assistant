...
namespace MultiplayerAssistant.HostAutomatorStages
{
    internal class UnlockCommunityCenterBehaviorLink : BehaviorLink
    {
        ...
        {
            if (!Game1.player.eventsSeen.Contains("611439") && Game1.player.stats.DaysPlayed > 4 && Game1.timeOfDay >= 800 && Game1.timeOfDay <= 1300 && !Game1.IsRainingHere(Game1.getLocationFromName("Town")) && !isUnlocking && !Utility.isFestivalDay(Game1.Date.DayOfMonth, Game1.Date.Season))
            {
